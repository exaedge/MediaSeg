...
def build_strings(min_reliable_chunk_size_mb):
    return {
        LANG_EN: {
            ...
            "overlay_preparing_body": "Controls are temporarily locked.",
            "overlay_converting_title": "Converting",
            "overlay_converting_body": "Controls are temporarily locked.",
            "overlay_splitting_title": "Splitting",
            "overlay_splitting_body": "Controls are temporarily locked.",
            "overlay_cleaning_title": "Cleaning",
            "overlay_cleaning_body": "Controls are temporarily locked.",
        },
        LANG_JA: {
            "menu_button": "オプション",
            "menu_theme": "テーマ",
            ...
            "overlay_preparing_body": "操作は一時的にロックされています。",
            "overlay_converting_title": "変換中",
            "overlay_converting_body": "操作は一時的にロックされています。",
            "overlay_splitting_title": "分割中",
            "overlay_splitting_body": "操作は一時的にロックされています。",
            "overlay_cleaning_title": "整理中",
            "overlay_cleaning_body": "操作は一時的にロックされています。",
        },
        LANG_VI: {
            ...
            "overlay_preparing_body": "Các điều khiển tạm thời bị khóa.",
            "overlay_converting_title": "Đang chuyển đổi",
            "overlay_converting_body": "Các điều khiển tạm thời bị khóa.",
            "overlay_splitting_title": "Đang chia",
            "overlay_splitting_body": "Các điều khiển tạm thời bị khóa.",
            "overlay_cleaning_title": "Đang dọn",
            "overlay_cleaning_body": "Các điều khiển tạm thời bị khóa.",
        },
    }
